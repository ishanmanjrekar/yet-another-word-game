...
export const ChunkyButton: React.FC<ChunkyButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-primary text-on-primary border-b-4 border-[var(--chunky-shadow-primary)] text-3xl px-8 py-3 rounded-xl",
    secondary: "bg-secondary-container text-secondary border-b-4 border-[var(--chunky-shadow-secondary)] text-2xl px-6 py-2 rounded-xl",
